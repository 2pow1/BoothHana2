...
public final class ApiModels {
    ...
    public record EventView(Long id, String name, Instant startAt, Instant endAt, String venue, String description, String imageUrl, Instant reservationStartAt, Instant reservationEndAt, EventStatus status, long boothCount) {}
