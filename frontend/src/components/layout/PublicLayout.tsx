...
export function PublicLayout() {
  ...
  return <div className="page-shell">
    ...
    <main><Outlet /></main>
    <footer className="site-footer"><div className="site-footer-inner"><div><strong>BoothHana2</strong><p>행사, 크리에이터, 굿즈 예약 정보를 한 곳에서 확인합니다.</p></div><nav className="footer-links" aria-label="서비스 정보"><Link to="/events">행사</Link>{user ? <Link to="/creator">크리에이터 화면</Link> : <a href={loginUrl}>로그인</a>}</nav></div></footer>
  </div>
}
